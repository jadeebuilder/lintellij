  ...
  <div class="login-page">
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-xxl-7 col-xl-6 d-none d-xl-block">
          <div class="radar-main-wrapper">
            ...
            <img src="{{ asset('assets/img/login-shape-circle-text.png') }}" alt="image" class="img-fluid radar-main-shape-text">
          ...
          <div class="gradient-card py-sm-12 py-8 px-sm-8 px-5 rounded-5">
            ...
            <form>
              <div class="d-flex flex-wrap gap-xl-6 gap-4 align-items-center justify-content-center mt-6">
                <a href="#0" class="link d-inline-flex align-items-center justify-content-center gap-4 py-3 px-8 rounded-2 bg-neutral-6 login-with-btn">
                  <img src="{{ asset('assets/img/login-facebook.svg') }}" alt="image" class="img-fluid">
                  <span class="d-inline-block clr-neutral-80 fs-14">Facebook</span>
                </a>
                <a href="#0" class="link d-inline-flex align-items-center justify-content-center gap-4 py-3 px-8 rounded-2 bg-neutral-6 login-with-btn">
                  <img src="{{ asset('assets/img/login-google.svg') }}" alt="image" class="img-fluid">
                  <span class="d-inline-block clr-neutral-80 fs-14">Google</span>
                </a>
              </div>
              <div class="mt-8">
                <label class="clr-neutral-80 mb-2">User Name</label>
                <input type="text" name="#0" class="form-control border border-neutral-17 clr-neutral-90 :focus-clr-current rounded-2 py-4 px-4 bg-neutral-4 placeholder-50 focus-bg-none" placeholder="Enter your user name">
              </div>
              <div class="mt-8">
                <label class="clr-neutral-80 mb-2">Password</label>
                <div class="pass-field-area">
                  <input type="password" name="#0" class="form-control border border-neutral-17 clr-neutral-90 :focus-clr-current rounded-2 py-4 px-4 bg-neutral-4 placeholder-50 focus-bg-none" placeholder="Enter your password">
              ...
              <div class="d-flex flex-wrap align-items-center justify-content-between mt-8">
                <div class="form-check check-box check-box check-box-neutral-30 gap-1">
                  <input class="form-check-input check-box__input clr-white my-auto border-0 bg-neutral-17" type="checkbox" id="n30dash">
                  <label class="form-check-label clr-neutral-80 fs-12 ps-1" for="n30dash"> Remember me </label>
                </div>
                <a href="#0" class="link clr-neutral-80 fs-12 :clr-primary-key">Forgot Password ?</a>
              </div>
              ...
              <p class="mb-0 clr-neutral-80 text-center mt-8">Don't have an Account ? <a href="{{ route('register') }}" class="link clr-primary-key fw-semibold">Register</a></p>
              <div class="text-center mt-6">
                <a href="{{ route('home') }}" class="link d-inline-flex justify-content-center align-items-center gap-2 py-2 px-4 border border-primary-key bg-primary-key :bg-primary-30 rounded-pill fs-14 fw-bold text-center clr-white">
      ...
      <div class="login-copyright">
        <p class="mb-0 text-center clr-neutral-80">Copyright @2023 <span class="clr-white">Writebot</span></p>
      </div>
    </div>
    <img src="{{ asset('assets/img/login-shape-top.png') }}" alt="image" class="img-fluid login-shape login-shape-top">
    <img src="{{ asset('assets/img/login-shape-left.png') }}" alt="image" class="img-fluid login-shape login-shape-left">
    <img src="{{ asset('assets/img/login-shape-right.png') }}" alt="image" class="img-fluid login-shape login-shape-right">
    <img src="{{ asset('assets/img/login-shape-line-left.png') }}" alt="image" class="img-fluid login-shape login-shape-line-left">
    <img src="{{ asset('assets/img/login-shape-line-right.png') }}" alt="image" class="img-fluid login-shape login-shape-line-right">
  </div>
  <!-- /Login Section -->
  <!-- scrpts -->
